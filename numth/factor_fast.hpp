...
#include "primetest_fast.hpp"

// pollard-rho算法, O(n^0.25)
...
// 基于pollard-rho的质因数分解. O(n^0.25)
inline vector<pair<ll, int>> factor_fast(ll n) {
    assert(n >= 1);
